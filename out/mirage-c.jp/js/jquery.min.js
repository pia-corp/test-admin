...
!(function (e, t) {
    ...
    (k.extend = k.fn.extend =
      function () {
        ...
        for ('boolean' == typeof a && ((l = a), (a = arguments[s] || {}), s++), 'object' == typeof a || m(a) || (a = {}), s === u && ((a = this), s--); s < u; s++)
          if (null != (e = arguments[s])) for (t in e) (r = e[t]), '__proto__' !== t && a !== r && (l && r && (k.isPlainObject(r) || (i = Array.isArray(r))) ? ((n = a[t]), (o = i && !Array.isArray(n) ? [] : i || k.isPlainObject(n) ? n : {}), (i = !1), (a[t] = k.extend(l, o, r))) : void 0 !== r && (a[t] = r));
        return a;
      }),
    k.extend({
              ...
              : function (e, t, n) {
                  ...
                  if (c) {
                    ...
                    if (((u = [m ? c.firstChild : c.lastChild]), m && p)) {
                      ...
                      while ((a = (++s && a && a[l]) || (d = s = 0) || u.pop())) if ((x ? a.nodeName.toLowerCase() === f : 1 === a.nodeType) && ++d && (p && ((i = (o = a[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [S, d]), a === e)) break;
      ...
      (r = e[c]).style &&
        ...
        t
          ? ('none' === n && ((l[c] = Q.get(r, 'display') || null), l[c] || (r.style.display = '')),
            '' === r.style.display && se(r) && (l[c] = ((u = a = o = void 0), (a = (i = r).ownerDocument), (s = i.nodeName), (u = ce[s]) || ((o = a.body.appendChild(a.createElement(s))), (u = k.css(o, 'display')), o.parentNode.removeChild(o), 'none' === u && (u = 'block'), (ce[s] = u)))))
  ...
  (k.event = {
    ...
    (k.Event = function (e, t) {
      ...
      e && e.type
        ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? ke : Se), (this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target), (this.currentTarget = e.currentTarget), (this.relatedTarget = e.relatedTarget))
        : (this.type = e),
        t && k.extend(this, t),
    ...
    k.extend({
      ...
      ajax: function (e, t) {
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)), v.data && (v.processData || 'string' == typeof v.data) && ((f += (St.test(f) ? '&' : '?') + v.data), delete v.data), !1 === v.cache && ((f = f.replace(Ot, '$1')), (o = (St.test(f) ? '&' : '?') + '_=' + kt++ + o)), (v.url = f + o)),
            ...
            (o = function (e) {
              return function () {
                o &&
                  ...
                  'abort' === e ? r.abort() : 'error' === e ? ('number' != typeof r.status ? t(0, 'error') : t(r.status, r.statusText)) : t(Ut[r.status] || r.status, r.statusText, 'text' !== (r.responseType || 'text') || 'string' != typeof r.responseText ? {binary: r.response} : {text: r.responseText}, r.getAllResponseHeaders()));
              };
            }),
              (r.onload = o()),
